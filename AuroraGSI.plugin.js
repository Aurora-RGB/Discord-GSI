...
module.exports = class AuroraGSI {
    ...
    async start() {
        ...
        let muteModuleR = await muteModule;
        const {getUser} = await userModule,
            ...
            isMute = muteModuleR.isMute.bind(muteModuleR),
            isDeaf = muteModuleR.isDeaf.bind(muteModuleR),
            isSelfMute = muteModuleR.isSelfMute.bind(muteModuleR),
            isSelfDeaf = muteModuleR.isSelfDeaf.bind(muteModuleR);
